...
class Tag(models.Model):
    name = models.CharField(max_length=20, verbose_name="标签名",default=None)
...
class Comment(models.Model):
    ...
    url = models.URLField(default="http://yxc.com",verbose_name="个人主页")
    email = models.EmailField(default='1335909103@qq.com',verbose_name='个人邮箱')
